...
const styles = StyleSheet.create({
  ...
  accessBadgeText:    { fontFamily: fonts.inter, fontSize: 9, letterSpacing: 1, color: 'rgba(201,168,76,0.8)' },
  ...
  insightDay:         { fontFamily: fonts.inter, fontSize: 10, fontWeight: '600', color: colors.gold.medium, letterSpacing: 0.5, textTransform: 'uppercase' },
  insightTagRow:      { flexDirection: 'row', alignItems: 'center', gap: 6 },
  insightTag:         { fontFamily: fonts.inter, fontSize: 9, color: 'rgba(200,180,255,0.6)', letterSpacing: 0.5 },
  ...
  energyPct:          { fontFamily: fonts.inter, fontSize: 9, color: colors.purple.high, fontWeight: '600' },
  insightText:        { fontFamily: fonts.cormorantItalic, fontSize: 14, color: 'rgba(255,255,255,0.6)', lineHeight: 22 },
  ...
  upgradeBtn:         { borderRadius: 3, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(201,168,76,0.42)', backgroundColor: 'rgba(201,168,76,0.07)', paddingVertical: 16, alignItems: 'center' },
  upgradeBtnInner:    { paddingVertical: 17, alignItems: 'center', width: '100%' },
  upgradeBtnText:     { fontFamily: fonts.inter, fontSize: 12, fontWeight: '400', color: 'rgba(201,168,76,0.92)', letterSpacing: 1.5, textTransform: 'uppercase' },
