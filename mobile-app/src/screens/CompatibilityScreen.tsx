...
const styles = StyleSheet.create({
  ...
  matchHeaderText:    { fontFamily: fonts.inter, fontSize: 9, letterSpacing: 2, color: 'rgba(255,255,255,0.2)', textTransform: 'uppercase' },
  ...
  matchRowLocked:     { },
  matchElement:       { fontFamily: fonts.inter, fontSize: 11, color: 'rgba(255,255,255,0.4)', width: 38, fontWeight: '500' },
  ...
  matchPct:           { fontFamily: fonts.inter, position: 'absolute', right: 4, top: -5, fontSize: 9, color: colors.gold.medium },
  matchLabel:         { fontFamily: fonts.inter, fontSize: 10, color: 'rgba(200,180,255,0.55)', width: 68, textAlign: 'right', letterSpacing: 0.2 },
  ...
  featureDot:         { fontFamily: fonts.inter, fontSize: 12, color: 'rgba(201,168,76,0.55)', marginTop: 1 },
