  ...
  <div class="legal-page">
    ...
    <div class="legal-body">
      ...
      <section id="t1" class="legal-section">
        <h2 class="legal-section__heading">1. Acceptance of Terms</h2>
      ...
      <section id="t2" class="legal-section">
        <h2 class="legal-section__heading">2. Description of Service</h2>
        <div class="legal-section__content">
      ...
      <section id="t3" class="legal-section">
        <h2 class="legal-section__heading">3. AI-Generated Content Disclaimer</h2>
        <div class="legal-section__content">
      ...
      <section id="t4" class="legal-section">
        <h2 class="legal-section__heading">4. Eligibility</h2>
        <div class="legal-section__content">
      ...
      <section id="t5" class="legal-section">
        <h2 class="legal-section__heading">5. User Responsibilities &amp; Prohibited Conduct</h2>
        <div class="legal-section__content">
        <h3 class="legal-section__subheading">5.1 Your Responsibilities</h3>
        <ul>
        ...
        <h3 class="legal-section__subheading">5.2 Prohibited Conduct</h3>
      ...
      <section id="t6" class="legal-section">
        <h2 class="legal-section__heading">6. Payments, Pricing &amp; Billing</h2>
        <div class="legal-section__content">
        <h3 class="legal-section__subheading">6.1 Pricing</h3>
        ...
        <h3 class="legal-section__subheading">6.2 Payment Processing</h3>
        ...
        <h3 class="legal-section__subheading">6.3 Taxes</h3>
        ...
        <h3 class="legal-section__subheading">6.4 Failed Payments</h3>
      ...
      <section id="t7" class="legal-section">
        ...
        <h3 class="legal-section__subheading">7.2 Cancellation</h3>
      ...
      <section id="t8" class="legal-section">
        <h2 class="legal-section__heading">8. Refund Policy</h2>
        <div class="legal-section__content">
        <h3 class="legal-section__subheading">8.1 One-Time Digital Purchases</h3>
        ...
        <h3 class="legal-section__subheading">8.2 Subscription Refunds</h3>
      ...
      <section id="t9" class="legal-section">
        <h2 class="legal-section__heading">9. Intellectual Property</h2>
        <div class="legal-section__content">
        <h3 class="legal-section__subheading">9.1 Our Intellectual Property</h3>
        ...
        <h3 class="legal-section__subheading">9.2 Your Licence to Use Reports</h3>
        ...
        <h3 class="legal-section__subheading">9.3 AI-Generated Output Ownership</h3>
        ...
        <h3 class="legal-section__subheading">9.4 Feedback</h3>
      ...
      <section id="t10" class="legal-section">
        <h2 class="legal-section__heading">10. Disclaimer of Warranties</h2>
        <div class="legal-section__content">
      ...
      <section id="t11" class="legal-section">
        <h2 class="legal-section__heading">11. Limitation of Liability</h2>
        <div class="legal-section__content">
      ...
      <section id="t12" class="legal-section">
        <h2 class="legal-section__heading">12. Indemnification</h2>
        <div class="legal-section__content">
      ...
      <section id="t13" class="legal-section">
        <h2 class="legal-section__heading">13. Termination</h2>
        <div class="legal-section__content">
      ...
      <section id="t14" class="legal-section">
        <h2 class="legal-section__heading">14. Binding Arbitration &amp; Class Action Waiver</h2>
        <div class="legal-section__content">
        <div class="highlight-box">
        ...
        <h3 class="legal-section__subheading">14.1 Binding Arbitration</h3>
        ...
        <h3 class="legal-section__subheading">14.2 Class Action Waiver</h3>
        ...
        <h3 class="legal-section__subheading">14.3 Opt-Out Right</h3>
        ...
        <h3 class="legal-section__subheading">14.4 Exceptions</h3>
        ...
        <h3 class="legal-section__subheading">14.5 Informal Resolution First</h3>
      ...
      <section id="t15" class="legal-section">
        <h2 class="legal-section__heading">15. Governing Law</h2>
        <div class="legal-section__content">
      ...
      <section id="t16" class="legal-section">
        <h2 class="legal-section__heading">16. Force Majeure</h2>
        <div class="legal-section__content">
      ...
      <section id="t17" class="legal-section">
        <h2 class="legal-section__heading">17. Modifications to Terms</h2>
        <div class="legal-section__content">
      ...
      <section id="t18" class="legal-section">
        <h2 class="legal-section__heading">18. Severability &amp; Entire Agreement</h2>
        <div class="legal-section__content">
      ...
      <section id="t19" class="legal-section">
        <h2 class="legal-section__heading">19. Contact Information</h2>
        <div class="legal-section__content">
