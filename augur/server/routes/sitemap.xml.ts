export default defineEventHandler((event) => {
  ...
  const xml = [
    ...
    '  </url>',
    '  <url>',
    '    <loc>https://omenora.com/founding</loc>',
    `    <lastmod>${today}</lastmod>`,
    '    <changefreq>weekly</changefreq>',
    '    <priority>0.8</priority>',
    '    <xhtml:link rel="alternate" hreflang="en" href="https://omenora.com/founding"/>',
    '    <xhtml:link rel="alternate" hreflang="x-default" href="https://omenora.com/founding"/>',
    '  </url>',
    '  <url>',
    ...
    '  </url>',
    '  <url>',
    '    <loc>https://omenora.com/refund-policy</loc>',
    '    <lastmod>2026-04-10</lastmod>',
    '    <changefreq>monthly</changefreq>',
    '    <priority>0.3</priority>',
    '    <xhtml:link rel="alternate" hreflang="en" href="https://omenora.com/refund-policy"/>',
    '    <xhtml:link rel="alternate" hreflang="x-default" href="https://omenora.com/refund-policy"/>',
    '  </url>',
    '</urlset>',
  ].join('\n')
